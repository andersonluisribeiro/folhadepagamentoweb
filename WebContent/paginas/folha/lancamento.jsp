...
<body>
	...
	<div class="container">
		...
		<form role="form" action="${pageContext.request.contextPath}/CadastrarFolha" method="post">
			...
			<div class="row">
				<div class="col-md-4">
					<label for="id">ID</label> <input type="text" class="form-control" name="id" id="id" placeholder="Código da folha">
				</div>
				<div class="col-md-4">
					<label for="mes">Mês</label> <input type="text" class="form-control" name="mes" id="mes" placeholder="Mês da folha">
				</div>
				<div class="col-md-4">
					<label for="ano">Ano</label> <input type="text" class="form-control" name="ano" id="ano" placeholder="Ano da folha">
				</div>
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<label for="adiantamento">Adiatamento</label> <input type="text" class="form-control" name="adiantamento" id="adiantamento" placeholder="Adiantamento do empregado">
				</div>
			</div>
