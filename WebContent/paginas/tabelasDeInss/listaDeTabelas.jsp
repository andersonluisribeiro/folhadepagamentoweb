	...
	<div class="container">
		...
		<table class="table">
			<tr>
				...
				<th style="width: 70%">Ano de vigência</th>				
			...
			<c:forEach var="tabela" items="${dao.lista}">
				<tr>
					...
					<td class="button-column">
						<a class="btn btn-default btn-lg" href="${pageContext.request.contextPath}/EditarTabelaDeInss?id=${tabela.id}"><span class="glyphicon glyphicon-edit"></span></a>
					</td>
					<td class="button-column">						
						<form action="${pageContext.request.contextPath}/ExcluirTabelaDeInss">
		...
		<a href="${pageContext.request.contextPath}/paginas/tabelasDeInss/cadastroDeTabela.jsp" class="btn btn-primary btn-lg active">Nova</a>
