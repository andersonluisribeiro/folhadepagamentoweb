...
<body>
	...
	<div class="container">
		...
		<form role="form" action="${pageContext.request.contextPath}/AlterarTabelaDeInss" method="post">
			<div class="form-group">
				<label for="id">ID</label> <input type="text" class="form-control" name="id" id="id" placeholder="Código do Salário Mínimo" value="${tabela.id}">
			</div>
			<div class="form-group">
				<label for="anoDeVigencia">Ano de Vigência</label> <input type="text" class="form-control" name="anoDeVigencia" id="anoDeVigencia" placeholder="Ano de Vigência" value="${tabela.anoDeVigencia}">
			</div>
