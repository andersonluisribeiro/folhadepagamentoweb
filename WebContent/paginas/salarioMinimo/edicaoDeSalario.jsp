	...
	<div class="container">
		...
		<form role="form" action="${pageContext.request.contextPath}/AlterarSalarioMinimo" method="post">
			<div class="form-group">
				<label for="id">ID</label> <input type="text" class="form-control" name="id" id="id" value="${salario.id}" placeholder="Código do Salário Mínimo">
			</div>
			<div class="form-group">
				<label for="anoDeVigencia">Ano de Vigência</label> <input type="text" class="form-control" name="anoDeVigencia" id="anoDeVigencia" value="${salario.anoDeVigencia}" placeholder="Ano de Vigência">
			</div>			
			<div class="form-group">
				<label for="valor">Valor</label> <input type="text" class="form-control" name="valor" id="valor" value="${salario.valor}" placeholder="Valor do salário mínimo">
			</div>			
